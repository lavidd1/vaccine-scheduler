...
public class Appointment {
    ...
    public void makeAppointment () throws SQLException {
        ...
        String makeAppt = "INSERT INTO Appointments VALUES (?,?,?,?,?)";
        try {
            PreparedStatement statement = con.prepareStatement(makeAppt);
    ...
    public static class AppointmentBuilder {
        ...
        public int generateID () throws SQLException {
            ConnectionManager cm = new ConnectionManager();
            Connection con = cm.createConnection();
            String apptID = "SELECT MAX(id) AS id FROM Appointments";
            try {
                PreparedStatement statement = con.prepareStatement(apptID);
